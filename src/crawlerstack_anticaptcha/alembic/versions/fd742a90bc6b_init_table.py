...
Revision ID: fd742a90bc6b
Revises: 3a0124c1801a
Create Date: 2022-09-28 20:21:37.862119
...
revision = 'fd742a90bc6b'
down_revision = '3a0124c1801a'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table('captcha',
                    ...
                    sa.Column('creation_time', sa.DateTime(), nullable=True, comment='Creation time'),
