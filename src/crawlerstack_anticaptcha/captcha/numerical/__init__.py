...
class NumCaptchaOcr(object):
    ...
    def __init__(self, ocr: bool = True, det: bool = False, old: bool = False, beta: bool = False,
        ...
        if det:
            ocr = False
            self.__graph_path = os.path.join(self.model_path, 'common_det.onnx')
            self.__charset = []
        if ocr:
            if not beta:
                self.__graph_path = os.path.join(self.model_path, 'common_old.onnx')
                ...
                self.__graph_path = os.path.join(self.model_path, 'common.onnx')
